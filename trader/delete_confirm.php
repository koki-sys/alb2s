...
?>
<div class="container">
  <h1 class="text-center mt-3">削除確認画面</h1>
  <div class="row mt-3">
  ...
  <form action="delete_finish.php" method="post">
    ...
    <footer class="mb-5 fixed-bottom" style="margin: 0 13%;">
      <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-6">
          <input type="submit" value="確定する" class="btn btn-danger btn-block">
        </div>
        <div class="col-lg-3"></div>
      </div>
      <div class="row mt-3">
        <div class="col-lg-3"></div>
        <div class="col-lg-6">
          <a href="top.php" class="btn btn-outline-danger btn-block">戻る</a>
        </div>
        <div class="col-lg-3"></div>
      </div>
    </footer>
